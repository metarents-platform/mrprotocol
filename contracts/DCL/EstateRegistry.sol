...
contract EstateRegistry is Migratable, IEstateRegistry, ERC721Token, ERC721Receiver, Ownable, EstateStorage {
  ...
  */
   ...
   */
  function setEstateLandBalanceToken(address _newAddress) external {
    require(estateLandBalance == address(0), "estateLandBalance was set");
    // _setEstateLandBalanceToken(address(0x2b98C125733035cDE09d311F988845808EE270E6));
    _setEstateLandBalanceToken(_newAddress);
  }
}